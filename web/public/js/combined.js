    ...
    (function($) {
        ...
        Selectorator = (function() {
            ...
            Selectorator.prototype.generateRecursive = function() {
                var children, index, parent, parentSelector, selector;
                ...
                if (children.length > 1) {
                    index = children.index(this.element);
                ...
                for (y = 0; y < btnGroups.length; y++) {
                    ...
                    var z,
                        ...
                        for (z = 0; z < buttons.length; z++) {
                            ...
                            btnGroupContainer.append('<button class="' + btnClass + ' btn-sm" title="' + button.title + '" data-provider="' + ns + '" data-handler="' + buttonHandler + '"><i class="' + button.icon + '"></i> ' + btnText + '</button>')
            ...
            var instance = this,
                ...
                if (this.$editor == null) {
                    ...
                    if (options.savable) {
                        ...
                        editorFooter.append('<button class="btn btn-success" data-provider="' + ns + '" data-handler="' + saveHandler + '"><i class="glyphicon glyphicon-white glyphicon-ok"></i> Save</button>')
...
(function() {
    ...
    var s = /\s+/,
        n = function(a, b, c, d) {
            ...
            if ("object" === typeof c)
                ...
                c = c.split(s);
                f = 0;
                for (var e = c.length; f <
                    e; f++) a[b].apply(a, [c[f]].concat(d))
            } else return !0
        }, t = function(a, b, c) {
            var d, a = -1,
                f = b.length;
    ...
    e.extend(o.prototype, h, {
        ...
        url: function() {
            var a = e.result(this, "urlRoot") ||
                e.result(this.collection, "url") || u();
        ...
        change: function(a) {
            ...
            if (b) return this;
            for (; this._pending;) this._pending = !1, this.trigger("change",
                this, a), this._previousAttributes = e.clone(this.attributes);
            this._changing = !1;
            return this
        },
        ...
        changedAttributes: function(a) {
            ...
            var b, c = !1,
                ...
                f;
            for (f in a)
                if (!e.isEqual(d[f], b = a[f]))(c || (c = {}))[f] = b;
            return c
        },
        _computeChanges: function(a) {
            this.changed = {};
            for (var b = {}, c = [], d = this._currentAttributes, f = this._changes,
                    e = f.length - 2; 0 <= e; e -= 2) {
                var g = f[e],
                    i = f[e + 1];
    ...
    e.extend(p.prototype, h, {
        ...
        add: function(a, b) {
            var c, d, f, g, h = b && b.at,
                i = null == (b && b.sort) ? !0 : b.sort,
                a = e.isArray(a) ?
                    a.slice() : [a];
            for (c = a.length - 1; 0 <= c; c--)(d = this._prepareModel(a[c], b)) ? (a[c] = d, (f = null != d.id && this._byId[d.id]) || this._byCid[d.cid] ? (b && (b.merge && f) && (f.set(d.attributes, b), g = i), a.splice(c, 1)) : (d.on("all", this._onModelEvent, this), this._byCid[d.cid] = d, null != d.id && (this._byId[d.id] = d))) : (this.trigger("error", this, a[c], b), a.splice(c, 1));
            a.length && (g = i);
        ...
        remove: function(a, b) {
            ...
            for (d = a.length; c < d; c++)
                if (g = this.get(a[c])) delete this._byId[g.id], delete this._byCid[g.cid], f = this.indexOf(g), this.models.splice(f, 1), this.length--, b.silent || (b.index = f, g.trigger("remove", g, this, b)), this._removeReference(g);
            return this
        },
        push: function(a, b) {
        ...
        update: function(a, b) {
            var c, d, f, g, h = [],
                i = [],
                m = {}, j = this.model.prototype.idAttribute,
                b = e.extend({
                    add: !0,
                    merge: !0,
                    remove: !0
            ...
            d = 0;
            for (f = a.length; d < f; d++) c = a[d], g = this.get(c.id || c.cid || c[j]), b.remove && g && (m[g.cid] = !0), (b.add && !g || b.merge && g) && h.push(c);
            if (b.remove) {
                d = 0;
    ...
    e.each("forEach each map collect reduce foldl inject reduceRight foldr find detect filter select reject every all some any include contains invoke max min sortedIndex toArray size first head take initial rest tail last without indexOf shuffle lastIndexOf isEmpty".split(" "),
        function(a) {
    ...
    e.extend(v.prototype, h, {
        ...
        _bindRoutes: function() {
            if (this.routes)
                for (var a, b = e.keys(this.routes); null != (a = b.pop());) this.route(a, this.routes[a])
        },
        _routeToRegExp: function(a) {
            a = a.replace(E, "\\$&").replace(B,
                "(?:$1)?").replace(C, "([^/]+)").replace(D, "(.*?)");
            return RegExp("^" + a + "$")
        },
    ...
    e.extend(j.prototype, h, {
        ...
        start: function(a) {
            ...
            this._hasPushState ? g.$(window).bind("popstate", this.checkUrl) : this._wantsHashChange && "onhashchange" in window && !b ? g.$(window).bind("hashchange", this.checkUrl) : this._wantsHashChange &&
            ...
            this._wantsPushState && (this._hasPushState && b && a.hash) && (this.fragment = this.getHash().replace(w, ""), this.history.replaceState({}, document.title, this.root + this.fragment +
                a.search));
    ...
    e.extend(x.prototype, h, {
        ...
        _ensureElement: function() {
            if (this.el) this.setElement(e.result(this,
                "el"), !1);
            else {
    ...
    g.sync = function(a, b, c) {
        ...
        if (null == c.data && b && ("create" ===
            a || "update" === a || "patch" === a)) f.contentType = "application/json", f.data = JSON.stringify(c.attrs || b.toJSON(c));
...
PrettyJSON.view.Leaf = Backbone.View.extend({
    ...
    render: function() {
        ...
        if (state.type == "date" && this.dateFormat) {
            ...
            state.data = escape(state.data).replace(/%(..)/g, "&#x$1;");
        }
