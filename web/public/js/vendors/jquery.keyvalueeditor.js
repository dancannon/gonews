(function($) {
    ...
    var methods = {
        ...
        getLastRow: function(state) {
            ...
            var h;
            h = '<div class="keyvalueeditor-row keyvalueeditor-last form-group">';
            h += '<input type="text" class="keyvalueeditor-key form-control" placeHolder="' + pKey + '" name="keyvalueeditor-key"' + '"/>';
            h += '<input type="text" class="keyvalueeditor-value keyvalueeditor-value-text form-control" placeHolder="' + pValue + '" name="keyvalueeditor-value"' + '"/>';
        ...
        getNewRow: function(key, value, state) {
            ...
            var h;
            h = '<div class="keyvalueeditor-row form-group">';
            h += '<input type="text" class="keyvalueeditor-key form-control" placeHolder="' + pKey + '" name="keyvalueeditor-' + key + '" value="' + key + '"/>';

            h += '<input type="text" class="keyvalueeditor-value keyvalueeditor-value-text form-control" placeHolder="' + pValue + '" name="keyvalueeditor-' + value + '" value="' + value + '"/>';
