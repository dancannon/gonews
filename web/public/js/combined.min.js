...
}]),angular.module("template/modal/backdrop.html",[]).run(["$templateCache",function($templateCache){$templateCache.put("template/modal/backdrop.html",'<div class="modal-backdrop fade" ng-class="{in: animate}" ng-style="{\'z-index\': 1040 + index*10}"></div>')}]),angular.module("template/modal/window.html",[]).run(["$templateCache",function($templateCache){$templateCache.put("template/modal/window.html",'<div tabindex="-1" class="modal fade {{ windowClass }}" ng-class="{in: animate}" ng-style="{\'z-index\': 1050 + index*10, display: \'block\'}" ng-click="close($event)">\n    <div class="modal-dialog"><div class="modal-content" ng-transclude></div></div>\n</div>')}]),angular.module("template/pagination/pager.html",[]).run(["$templateCache",function($templateCache){$templateCache.put("template/pagination/pager.html",'<ul class="pager">\n  <li ng-repeat="page in pages" ng-class="{disabled: page.disabled, previous: page.previous, next: page.next}"><a ng-click="selectPage(page.number)">{{page.text}}</a></li>\n</ul>')}]),angular.module("template/pagination/pagination.html",[]).run(["$templateCache",function($templateCache){$templateCache.put("template/pagination/pagination.html",'<ul class="pagination">\n  <li ng-repeat="page in pages" ng-class="{active: page.active, disabled: page.disabled}"><a ng-click="selectPage(page.number)">{{page.text}}</a></li>\n</ul>')}]),angular.module("template/tooltip/tooltip-html-unsafe-popup.html",[]).run(["$templateCache",function($templateCache){$templateCache.put("template/tooltip/tooltip-html-unsafe-popup.html",'<div class="tooltip {{placement}}" ng-class="{ in: isOpen(), fade: animation() }">\n  <div class="tooltip-arrow"></div>\n  <div class="tooltip-inner" bind-html-unsafe="content"></div>\n</div>\n')}]),angular.module("template/tooltip/tooltip-popup.html",[]).run(["$templateCache",function($templateCache){$templateCache.put("template/tooltip/tooltip-popup.html",'<div class="tooltip {{placement}}" ng-class="{ in: isOpen(), fade: animation() }">\n  <div class="tooltip-arrow"></div>\n  <div class="tooltip-inner" ng-bind="content"></div>\n</div>\n')}]),angular.module("template/popover/popover.html",[]).run(["$templateCache",function($templateCache){$templateCache.put("template/popover/popover.html",'<div class="popover {{placement}}" ng-class="{ in: isOpen(), fade: animation() }">\n  <div class="arrow"></div>\n\n  <div class="popover-inner">\n      <h3 class="popover-title" ng-bind="title" ng-show="title"></h3>\n      <div class="popover-content" ng-bind="content"></div>\n  </div>\n</div>\n')}]),angular.module("template/progressbar/bar.html",[]).run(["$templateCache",function($templateCache){$templateCache.put("template/progressbar/bar.html",'<div class="progress-bar" ng-class="type && \'progress-bar-\' + type" ng-transclude></div>')}]),angular.module("template/progressbar/progress.html",[]).run(["$templateCache",function($templateCache){$templateCache.put("template/progressbar/progress.html",'<div class="progress" ng-transclude></div>')}]),angular.module("template/progressbar/progressbar.html",[]).run(["$templateCache",function($templateCache){$templateCache.put("template/progressbar/progressbar.html",'<div class="progress"><div class="progress-bar" ng-class="type && \'progress-bar-\' + type" ng-transclude></div></div>')}]),angular.module("template/rating/rating.html",[]).run(["$templateCache",function($templateCache){$templateCache.put("template/rating/rating.html",'<span ng-mouseleave="reset()">\n    <i ng-repeat="r in range" ng-mouseenter="enter($index + 1)" ng-click="rate($index + 1)" class="glyphicon" ng-class="$index < val && (r.stateOn || \'glyphicon-star\') || (r.stateOff || \'glyphicon-star-empty\')"></i>\n</span>')}]),angular.module("template/tabs/tab.html",[]).run(["$templateCache",function($templateCache){$templateCache.put("template/tabs/tab.html",'<li ng-class="{active: active, disabled: disabled}">\n  <a ng-click="select()" tab-heading-transclude>{{heading}}</a>\n</li>\n')}]),angular.module("template/tabs/tabset-titles.html",[]).run(["$templateCache",function($templateCache){$templateCache.put("template/tabs/tabset-titles.html","<ul class=\"nav {{type && 'nav-' + type}}\" ng-class=\"{'nav-stacked': vertical}\">\n</ul>\n")}]),angular.module("template/tabs/tabset.html",[]).run(["$templateCache",function($templateCache){$templateCache.put("template/tabs/tabset.html",'\n<div class="tabbable">\n  <ul class="nav {{type && \'nav-\' + type}}" ng-class="{\'nav-stacked\': vertical, \'nav-justified\': justified}" ng-transclude></ul>\n  <div class="tab-content">\n    <div class="tab-pane" \n         ng-repeat="tab in tabs" \n         ng-class="{active: tab.active}"\n         tab-content-transclude="tab">\n    </div>\n  </div>\n</div>\n')}]),angular.module("template/timepicker/timepicker.html",[]).run(["$templateCache",function($templateCache){$templateCache.put("template/timepicker/timepicker.html",'<table>\n	<tbody>\n		<tr class="text-center">\n			<td><a ng-click="incrementHours()" class="btn btn-link"><span class="glyphicon glyphicon-chevron-up"></span></a></td>\n			<td>&nbsp;</td>\n			<td><a ng-click="incrementMinutes()" class="btn btn-link"><span class="glyphicon glyphicon-chevron-up"></span></a></td>\n			<td ng-show="showMeridian"></td>\n		</tr>\n		<tr>\n			<td style="width:50px;" class="form-group" ng-class="{\'has-error\': invalidHours}">\n				<input type="text" ng-model="hours" ng-change="updateHours()" class="form-control text-center" ng-mousewheel="incrementHours()" ng-readonly="readonlyInput" maxlength="2">\n			</td>\n			<td>:</td>\n			<td style="width:50px;" class="form-group" ng-class="{\'has-error\': invalidMinutes}">\n				<input type="text" ng-model="minutes" ng-change="updateMinutes()" class="form-control text-center" ng-readonly="readonlyInput" maxlength="2">\n			</td>\n			<td ng-show="showMeridian"><button type="button" class="btn btn-default text-center" ng-click="toggleMeridian()">{{meridian}}</button></td>\n		</tr>\n		<tr class="text-center">\n			<td><a ng-click="decrementHours()" class="btn btn-link"><span class="glyphicon glyphicon-chevron-down"></span></a></td>\n			<td>&nbsp;</td>\n			<td><a ng-click="decrementMinutes()" class="btn btn-link"><span class="glyphicon glyphicon-chevron-down"></span></a></td>\n			<td ng-show="showMeridian"></td>\n		</tr>\n	</tbody>\n</table>\n')}]),angular.module("template/typeahead/typeahead-match.html",[]).run(["$templateCache",function($templateCache){$templateCache.put("template/typeahead/typeahead-match.html",'<a tabindex="-1" bind-html-unsafe="match.label | typeaheadHighlight:query"></a>')}]),angular.module("template/typeahead/typeahead-popup.html",[]).run(["$templateCache",function($templateCache){$templateCache.put("template/typeahead/typeahead-popup.html","<ul class=\"dropdown-menu\" ng-style=\"{display: isOpen()&&'block' || 'none', top: position.top+'px', left: position.left+'px'}\">\n"+'    <li ng-repeat="match in matches" ng-class="{active: isActive($index) }" ng-mouseenter="selectActive($index)" ng-click="selectMatch($index)">\n        <div typeahead-match index="$index" match="match" query="query" template-url="templateUrl"></div>\n    </li>\n</ul>')}]),angular.module("ui.keyvalue",[]).controller("KeyValueCtrl",["$scope","$attrs",function($scope){$scope.$watch("keyvalue",function(value){value&&($scope.values=value)}),$scope.values.value=function(){var tmp={};return $.each(this,function(index,param){param.active&&(tmp[param.key]=param.value)}),tmp},$scope.addValue=function(){$scope.values.length>0&&($scope.values[$scope.values.length-1].active=!0),$scope.values.push({active:!1})},$scope.deleteValue=function(index){$scope.values[index].preset||$scope.values.splice(index,1)}}]).directive("keyvalue",function(){return{restrict:"EA",transclude:!1,replace:!0,scope:{values:"=ngModel"},templateUrl:"/js/templates/keyvalue/keyvalue.html",controller:"KeyValueCtrl",link:function(scope){(0===scope.values.length||scope.values[scope.values.length-1].active)&&scope.values.push({active:!1})}}}),$(function(){var adjustheight=125,moreText="+  More",lessText="- Less";$(".text-post-type .post-details .post-description").actual("height")>adjustheight&&($(".text-post-type .post-details .post-description").css("height",adjustheight).css("overflow","hidden"),$(".text-post-type .post-details").append('<a href="#" class="adjust"></a>'),$("a.adjust").text(moreText),$(".adjust").click(function(e){$(this).parents("div.post-details").find(".post-description").data("expanded")!==!0?($(this).parents("div.post-details").find(".post-description").css("height","auto").css("overflow","visible").data("expanded",!0),$(this).text(lessText)):($(this).parents("div.post-details").find(".post-description").css("height",adjustheight).css("overflow","hidden").data("expanded",!1),$(this).text(moreText)),e.preventDefault()}))});var ruleBuilder=angular.module("ruleBuilder",["ui.keyvalue","ui.ace","ui.bootstrap"]);ruleBuilder.config(function($locationProvider){$locationProvider.html5Mode(!0)}),ruleBuilder.config(function($interpolateProvider){$interpolateProvider.startSymbol("[["),$interpolateProvider.endSymbol("]]")}),ruleBuilder.filter("empty",function(){return function(input){return _.isEmpty(input)}}),ruleBuilder.controller("RuleCtrl",function($scope,$http,$location,$sce){function getExtractorParams(name,addRow){"undefined"==typeof addRow&&(addRow=!0);var params=[];return $.each($scope.extractors,function(index,extractor){return name===extractor.id?(params=_.extend([],extractor.params),params=_.map(params,function(param){return param.active=!0,param}),addRow&&params.push({active:!1}),!1):void 0}),params}if($scope.extractors=[{id:"oembed",name:"OEmbed",params:[{key:"endpoint",name:"OEmbed Endpoint (Required)",value:"",required:!0,preset:!0}]},{id:"opengraph",name:"OpenGraph",params:[]},{id:"selector",name:"CSS Selector (Raw Content)",params:[{key:"selector",name:"CSS Selector (Required)",value:"",required:!0,preset:!0},{key:"attribute",name:"Attribute",value:"",preset:!0},{key:"restype",name:"Result Type",value:"",choices:{"":"",first:"First Result",all:"All Results",merge:"Merge Results"},preset:!0}]},{id:"selector_text",name:"CSS Selector (Text Only)",params:[{key:"selector",name:"CSS Selector (Required)",value:"",required:!0,preset:!0},{key:"attribute",name:"Attribute",value:"",preset:!0},{key:"restype",name:"Result Type",value:"",choices:{"":"",first:"First Result",all:"All Results",merge:"Merge Results"},preset:!0}]},{id:"text",name:"Text",params:[{key:"format",name:"Result Format",value:"raw",choices:{raw:"Raw",text:"Text"},preset:!0}]},{id:"title",name:"Page Title",params:[]},{id:"url_mapper",name:"URL mapper",params:[{key:"pattern",name:"Pattern",value:"",required:!0,preset:!0},{key:"replacement",name:"Replacement",value:"",required:!0,preset:!0}]},{id:"javascript",name:"JS Script",params:[{key:"script",name:"Script",value:"",required:!0,preset:!0}]}],$scope.types={extractor:[new Value({type:"extractor"})],general:[new Value({name:"title",type:"extractor",value:"title"}),new Value({name:"content"})],text:[new Value({name:"title",type:"extractor",value:"title"}),new Value({name:"text",type:"extractor",value:"text"})],image:[new Value({name:"title",type:"extractor",value:"title"}),new Value({name:"caption",type:"extractor",value:"selector"}),new Value({name:"author",type:"values",value:[new Value({name:"name",type:"extractor",value:"selector"}),new Value({name:"url",type:"extractor",value:"selector"})]}),new Value({name:"thumbnail",type:"values",value:[new Value({name:"url",type:"extractor",value:"selector"}),new Value({name:"width",type:"extractor",value:"selector"}),new Value({name:"height",type:"extractor",value:"selector"})]}),new Value({name:"url",type:"extractor",value:"selector"}),new Value({name:"height",type:"extractor",value:"selector"}),new Value({name:"width",type:"extractor",value:"selector"})],video:[new Value({name:"title",type:"extractor",value:"title"}),new Value({name:"description",type:"extractor",value:"selector"}),new Value({name:"author",type:"values",value:[new Value({name:"name",type:"extractor",value:"selector"}),new Value({name:"url",type:"extractor",value:"selector"})]}),new Value({name:"thumbnail",type:"values",value:[new Value({name:"url",type:"extractor",value:"selector"}),new Value({name:"width",type:"extractor",value:"selector"}),new Value({name:"height",type:"extractor",value:"selector"})]}),new Value({name:"html",type:"extractor",value:"selector"})],rich:[new Value({name:"title",type:"extractor",value:"title"}),new Value({name:"html",type:"extractor",value:"selector"}),new Value({name:"height",type:"extractor",value:"selector"}),new Value({name:"width",type:"extractor",value:"selector"})]},$scope.error="",$scope.action="",$scope.submitted=!1,$scope.mode="simple",$scope.id="",$scope.name="",$scope.test_url="",$scope.host="",$scope.path_pattern="/.*",$scope.type="unknown",$scope.values=[],$scope.container={newname:"",selected:null,restype:""},!_.isEmpty(rule)){$scope.id=rule.id||"",$scope.name=rule.name||"",$scope.host=rule.host||"",$scope.path_pattern=rule.path_pattern||"/.*",$scope.test_url=rule.test_url||"",$scope.type=rule.type||"unknown";var loadValues=function(values){var tmp=[];return $.each(values,function(index,value){if("extractor"===value.type){var params=getExtractorParams(value.id,!1);$.each(value.params,function(pk,pv){var found=!1;$.each(params,function(pindex,defaultParam){defaultParam.key===pk&&(params[pindex]=_.extend(_.clone(defaultParam),{value:pv}),found=!0)}),found||params.push({key:pk,value:pv,active:!0})}),params.push({active:!1}),tmp.push(new Value({name:value.name,type:"extractor",value:value.id,params:params}))}else if("values"===value.type){{loadValues(value)}tmp.push(new Value({name:value.name,type:"values",value:loadValues(value.value)}))}else"value"===value.type&&tmp.push(new Value(value))}),tmp};null!==rule.values&&($scope.values=loadValues(rule.values))}var prepareValues=function(values){var tmp;return"object"==typeof values?values instanceof Value?"extractor"===values.type?{name:values.name,id:values.value,type:"extractor",params:_.object(_.map(values.params,function(x){return[x.key,x.value]}))}:{name:values.name,type:values.type,value:prepareValues(values.value)}:(tmp=[],$.each(values,function(index,value){tmp.push(prepareValues(value))}),tmp):Array.isArray(values)?(tmp=[],$.each(values,function(index,value){tmp.push(prepareValues(value))}),tmp):values};$scope.onSubmit=function(){$scope.submitted=!0,$scope.form.$invalid||("test"==$scope.action?$scope.onSubmitTestRule():$scope.onSubmitSaveRule())},$scope.onSubmitSaveRule=function(){$http.post("/rule/save",{post_id:post_id,rule:{id:$scope.id,name:$scope.name,type:"extractor"===$scope.type?"unknown":$scope.type,host:$scope.host,path_pattern:$scope.path_pattern,test_url:$scope.test_url,values:prepareValues($scope.values)}}).success(function(data){$scope.error="",$scope.id=data.id,$location.path()!=="/rule/edit/"+data.id&&$location.path("/rule/edit/"+data.id);{var $el=$("#result-preview");new PrettyJSON.view.Node({el:$el,data:data.response})}window.location.hash="#preview"}).error(function(data,status){$scope.error=data.error?"That rule was not valid ("+data.error+")":400==status?"That rule was not valid":"An error occurred, please try again later"})},$scope.onSubmitTestRule=function(){$http.post("/rule/test",{rule:{name:$scope.name,type:"extractor"===$scope.type?"unknown":$scope.type,host:$scope.host,path_pattern:$scope.path_pattern,test_url:$scope.test_url,values:prepareValues($scope.values)}}).success(function(data){{var $el=$("#result-preview");new PrettyJSON.view.Node({el:$el,data:data.response})}window.location.hash="#preview"}).error(function(data,status){$scope.error=data.error?"That rule was not valid ("+data.error+")":400==status?"That rule was not valid":"An error occurred, please try again later"})},$scope.onUpdateExtractorType=function(value){value.params=getExtractorParams(value.value)},$scope.onUpdateRuleType=function(){$.each($scope.types,function(id,type){return $scope.type==id?($scope.values=type,void $.each($scope.values,function(key,value){"extractor"===value.type&&(value.params=getExtractorParams(value.value))})):void 0})},$scope.addValue=function(){""!==$scope.container.newname&&($scope.values=$scope._addValue($scope.values,new Value({name:$scope.container.newname})),$scope.container.newname="")},$scope.addChildValue=function(parent){""!==parent.newname&&(parent.value=$scope._addValue(new Value({name:parent.newname})),parent.newname="")},$scope.addSimpleValue=function(){if(""!==$scope.container.newname){var elements=$("#rule-builder-simple iframe").contents().find(".highlight-selected");elements.removeClass("highlight-selected");var selectors=_.map(elements,function(el){return $(el).getSelector({ignore:{classes:["highlight-selected","highlight"]}})});$scope.values=$scope._addValue($scope.values,new Value({name:$scope.container.newname,value:"selector",type:"extractor",params:[{active:!0,key:"selector",name:"CSS Selector (Required)",preset:!0,required:!0,value:selectors.join(", ")},{active:!0,key:"restype",name:"Result Type",preset:!0,required:!1,value:$scope.container.restype},{active:!1}]})),$scope.container.newname=""}},$scope._addValue=function(values,value){Array.isArray(values)||(values=[]);for(var i=values.length-1;i>=0;i--)if(values[i].name==value.name)return values[i]=value,values;return values.push(value),values},$scope.updateValue=function(){if(null!==$scope.container.selected){var iframe=$("#rule-builder-simple-iframe").contents(),elements=iframe.find(".highlight-selected");elements.removeClass("highlight-selected");for(var selectors=_.map(elements,function(el){return $(el).getSelector({ignore:{classes:["highlight-selected","highlight"]}})}),selector=selectors.join(", "),i=$scope.container.selected.params.length-1;i>=0;i--){var param=$scope.container.selected.params[i];"selector"===param.key&&(param.value=selector)}iframe.find(selector).addClass("highlight-selected")}},$scope.deleteValue=function(index){$scope.values.splice(index,1)},$scope.onUpdateValueType=function(value){"value"==value.type?value.value="":"values"==value.type?value.value=[]:"extractor"==value.type&&(value.value="")},$scope.onUpdateSelectedValues=function(){var iframe=$("#rule-builder-simple-iframe").contents();if(iframe.find(".highlight-selected").removeClass("highlight-selected"),null!==$scope.container.selected){for(var selector="",i=$scope.container.selected.params.length-1;i>=0;i--){var param=$scope.container.selected.params[i];"selector"===param.key&&(selector=param.value)}iframe.find(selector).addClass("highlight-selected")}},$scope.onTestUrlChange=function(){"simple"===$scope.mode&&$scope.initSimple()},$scope.trustSrc=function(src){return $sce.trustAsResourceUrl(src)},$scope.initSimple=function(){window.updateTestUrl=function(test_url){$scope.test_url=test_url},$scope.mode="simple"},$scope.initAdvanced=function(){$scope.mode="advanced"},$scope.startIframe=function(){$("#rule-builder-simple-iframe").attr("src","/rule/load_url?url="+$scope.test_url).removeClass("hide"),$("#rule-builder-simple .navbar .navbar-form").removeClass("hide"),$("#rule-builder-simple-placeholder").addClass("hide")},$scope.reloadIframe=function(){$("#rule-builder-simple-iframe").attr("src","/rule/load_url?url="+$scope.test_url)},$scope.initSimple()});var $el=$("#result-preview"),node=new PrettyJSON.view.Node({el:$el,data:{}});
